    ...
    entries = (
        HarnessDefinition(
            ...
            onboarding=OnboardingMetadata(
                description="Deterministic local harness for testing JoyMesh without inference.",
                recommended_for=("evaluation", "CI", "offline demonstrations"),
                setup_difficulty="easy",
                installation_methods=("bundled",),
                authentication_modes=("none",),
                subscription_or_funding_modes=("local",),
                can_install_automatically=True,
                can_verify_subscription=True,
                certification_cost="free",
        ...
        HarnessDefinition(
            ...
            onboarding=OnboardingMetadata(
                description="OpenAI's coding agent CLI with structured non-interactive execution.",
                recommended_for=("repository changes", "code review", "automation"),
                setup_difficulty="easy",
                installation_methods=("npm",),
                authentication_modes=("OAuth", "API key"),
                subscription_or_funding_modes=("subscription", "paid API"),
                can_install_automatically=True,
                can_verify_subscription=True,
                certification_cost="low inference cost",
                requires_paid_inference=True,
                default_paid_route_policy="ask",
                fireconnect_compatible=False,
                supported_platforms=("darwin", "linux", "win32"),
                known_limitations=("Certification requires an authenticated account.",),
            ),
        ),
        HarnessDefinition(
            id="opencode",
            ...
            adapter_certification=CertificationState.FAKE_BINARY_CONFORMANCE_PASSED,
            onboarding=OnboardingMetadata(
                description="Provider-flexible coding agent with JSON event output.",
                recommended_for=("multi-provider routing", "local models", "automation"),
                setup_difficulty="moderate",
                installation_methods=("npm",),
                authentication_modes=("interactive provider login", "environment credential"),
                subscription_or_funding_modes=("provider subscription", "paid API", "local"),
                can_install_automatically=True,
                can_verify_subscription=False,
                certification_cost="depends on provider",
                requires_paid_inference=True,
                default_paid_route_policy="ask",
                fireconnect_compatible=True,
                supported_platforms=("darwin", "linux", "win32"),
                known_limitations=("Funding status may remain unknown for some providers.",),
            ),
        ),
        HarnessDefinition(
            id="claude-code",
